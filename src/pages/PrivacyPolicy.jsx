            ...
            <main style={{ padding: '140px 5% 100px', maxWidth: 800, margin: '0 auto' }}>
                ...
                <div style={{ color: '#475569', lineHeight: 1.8, fontSize: '1.1rem' }}>
                    <p style={{ marginBottom: '24px' }}>
                        Welcome to DogMart. We take the privacy and security of both our human users and their canine companions extremely seriously.
                    ...
                    <div style={{ background: 'white', padding: '24px', borderRadius: '16px', marginBottom: '20px', border: '1px solid #E2E8F0' }}>
                        ...
                        <p style={{ fontSize: '0.95rem', color: '#64748B', background: '#F8FAFC', padding: '12px', borderRadius: '8px' }}>
                            <strong>Why:</strong> Pet parents are trusting you with members of their family and access to their homes. Rigorous identity verification is the cornerstone of DogMart's safety guarantee. We do not use this ID for any marketing purposes, strictly for background verification.
                        </p>
                    </div>
                    ...
                    <div style={{ background: 'white', padding: '24px', borderRadius: '16px', marginBottom: '20px', border: '1px solid #E2E8F0' }}>
                        ...
                        <p style={{ fontSize: '0.95rem', color: '#64748B', background: '#F8FAFC', padding: '12px', borderRadius: '8px' }}>
                            <strong>Why:</strong> DogMart is a hyperlocal service. Precise location allows us to show you groomers and walkers who are actually in your neighborhood. We also use push notification tokens to alert you immediately when a booking is confirmed or a chat message arrives.
                        </p>
                    </div>
                    ...
                    <ul style={{ marginLeft: '24px', marginBottom: '24px' }}>
                        ...
                        <li style={{ marginBottom: '8px' }}><strong>Payment Processing:</strong> Financial details are vaulted directly by our payment partner (Razorpay). We do not store credit card numbers on DogMart servers.</li>
