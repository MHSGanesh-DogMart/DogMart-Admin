                        ...
                        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
                            {listing.status === 'pending' && (
                                <>
                                    ...
                                    <button className="btn btn-danger" onClick={() => setShowReject(true)} disabled={actioning} style={{ flex: 1, justifyContent: 'center' }}>
...
export default function Listings() {
    ...
    const refresh = async () => {
        ...
        try {
            ...
            const res = await api.get(`/admin/listings?status=${status}`);
