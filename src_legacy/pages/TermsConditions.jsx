            ...
            <main style={{ padding: '140px 5% 100px', maxWidth: 800, margin: '0 auto' }}>
                ...
                <div style={{ color: '#475569', lineHeight: 1.8, fontSize: '1.1rem' }}>
                    <p style={{ marginBottom: '30px' }}>
                        Welcome to PetSaathi. By accessing or using the PetSaathi mobile application, website, or associated services (collectively, the "Platform"),
                    ...
                    <h3 style={{ fontSize: '1.5rem', color: '#1E293B', marginTop: '40px', marginBottom: '16px' }}>1. The Role of PetSaathi</h3>
                    <div style={{ background: '#F8FAFC', padding: '24px', borderRadius: '16px', borderLeft: '4px solid #3B82F6', marginBottom: '24px' }}>
                        ...
                        <p style={{ fontSize: '0.95rem' }}>
                            PetSaathi provides a technology platform that connects pet owners ("Pet Parents") with independent third-party pet care
                            service providers ("Providers") such as groomers, dog walkers, and boarders. PetSaathi does not employ these Providers
                    ...
                    <ul style={{ marginLeft: '24px', marginBottom: '24px' }}>
                        ...
                        <li style={{ marginBottom: '12px' }}>
                            <strong>Health & Vaccinations:</strong> All dogs participating in boarding, walking, or grooming services booked through PetSaathi MUST be up-to-date on standard vaccinations (Rabies, DHLPP). Providers have the right to request proof before beginning service.
                        </li>
                        <li style={{ marginBottom: '12px' }}>
                    ...
                    <ul style={{ marginLeft: '24px', marginBottom: '24px' }}>
                        <li style={{ marginBottom: '12px' }}>
                            <strong>Secure Transactions:</strong> All payments for services booked through PetSaathi must be completed via the platform's integrated payment gateway (Razorpay). Paying Providers in cash directly violates our Terms and voids any platform support or guarantees.
                        </li>
                        <li style={{ marginBottom: '12px' }}>
                        ...
                        <li style={{ marginBottom: '12px' }}>
                            <strong>Platform Fees:</strong> PetSaathi charges a variable commission rate on the total booking value for Service Providers to maintain platform infrastructure, verification processes, and customer support.
                        </li>
                    </ul>
                    ...
                    <p style={{ marginBottom: '16px' }}>
                        ...
                        Subscriptions auto-renew unless cancelled at least 24 hours before the end of the current billing period. PetSaathi does not offer prorated refunds for mid-cycle cancellations.
                    </p>

                    <h3 style={{ fontSize: '1.5rem', color: '#1E293B', marginTop: '40px', marginBottom: '16px' }}>5. Limitation of Liability</h3>
                    <p style={{ marginBottom: '16px' }}>
                        While PetSaathi conducts background checks on Providers, we cannot guarantee the quality or safety of every transaction.
                        PetSaathi is not liable for any injuries, damages, or losses to pets, property, or persons that occur during a service booked through the platform.
